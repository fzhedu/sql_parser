...
AstExprConst::AstExprConst(string expr_type, string data)
        : AstNode(AST_EXPR_CONST),
...
AstExprUnary::AstExprUnary(string expr_type, AstNode* arg0)
        : AstNode(AST_EXPR_UNARY),
          expr_type_(expr_type),
          arg0_(arg0) {
}
...
AstExprCalBinary::AstExprCalBinary(std::string expr_type, AstNode* arg0,
                                   AstNode* arg1)
        : AstNode(AST_EXPR_CAL_BINARY),
          expr_type_(expr_type),
          arg0_(arg0),
          arg1_(arg1) {
}
...
AstExprCmpBinary::AstExprCmpBinary(string expr_type, AstNode* arg0,
                                   AstNode* arg1)
        : AstNode(AST_EXPR_CMP_BINARY),
          expr_type_(expr_type),
          cmp_para_(""),
          arg0_(arg0),
          arg1_(arg1) {
}
AstExprCmpBinary::AstExprCmpBinary(string cmp_para, int cmp_type, AstNode* arg0,
                                   AstNode* arg1)
        : AstNode(AST_EXPR_CMP_BINARY),
          cmp_para_(cmp_para),
          arg0_(arg0),
...
AstExprList::AstExprList(AstNode* expr, AstNode* next)
        : AstNode(AST_EXPR_LIST),
          expr_(expr),
          next_(next) {
}
...
AstExprFunc::AstExprFunc(std::string expr_type, AstNode* arg0, AstNode* arg1,
                         AstNode* arg2)
        : AstNode(AST_EXPR_FUNC),
          expr_type_(expr_type),
          arg0_(arg0),
          arg1_(arg1),
          arg2_(arg2) {
